...
class CUB2011Parts_dataset(VisionDataset):
    ...
    def _load_attributes(root):
        ...
        attr_list = pd.read_csv(os.path.join(root, 'CUB_200_2011', 'attributes.txt'), sep=' ', names=['attr_id', 'def'])
        ...
        attributes = pd.read_csv(os.path.join(root, 'CUB_200_2011', 'attributes', 'image_attribute_labels.txt'), sep=' ', names=['img_id', 'attr_id', 'is_present', 'certainty', 'time'])
